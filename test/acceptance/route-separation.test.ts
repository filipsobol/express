...
import app from '../../examples/route-separation';

describe('route-separation', () => {
  describe('GET /', () => {
    it('should respond with index', () => new Promise(done => {
      request(app)
      .get('/')
  ...
  describe('GET /users', () => {
    it('should list users', () => new Promise(done => {
      request(app)
      .get('/users')
      .expect(/TJ/)
      .expect(/Tobi/)
  ...
  describe('GET /user/:id', () => {
    ...
    it('should 404 on missing user', () => new Promise(done => {
      request(app)
      .get('/user/10')
      .expect(404, done)
    } ) );
  ...
  describe('GET /user/:id/edit', () => {
    it('should get a user to edit', () => new Promise(done => {
      request(app)
      .get('/user/0/edit')
  ...
  describe('PUT /user/:id/edit', () => {
    it('should edit a user', () => new Promise(done => {
      request(app)
      .put('/user/0/edit')
  ...
  describe('GET /posts', () => {
    it('should get a list of posts', () => new Promise(done => {
      request(app)
      .get('/posts')
