...
import app from '../../examples/vhost';

describe('vhost', () => {
  describe('example.com', () => {
    describe('GET /', () => {
      it('should say hello', () => new Promise(done => {
        request(app)
        .get('/')
    ...
    describe('GET /foo', () => {
      it('should say foo', () => new Promise(done => {
        request(app)
        .get('/foo')
        .set('Host', 'example.com')
  ...
  describe('foo.example.com', () => {
    describe('GET /', () => {
      it('should redirect to /foo', () => new Promise(done => {
        request(app)
        .get('/')
  ...
  describe('bar.example.com', () => {
    describe('GET /', () => {
      it('should redirect to /bar', () => new Promise(done => {
        request(app)
        .get('/')
