...
describe('app.router', () => {
  ...
  describe('methods', () => {
    methods.concat('del').forEach((method) => {
      ...
      it('should include ' + method.toUpperCase(), () => new Promise(done => {
    ...
    it('should re-route when method is altered', () => new Promise(done => {
      var app = express();
      var cb = after(3, done);
  ...
  describe('decode params', () => {
    it('should decode correct params', () => new Promise(done => {
      var app = express();
    ...
    it('should not accept params in malformed paths', () => new Promise(done => {
      var app = express();
    ...
    it('should not decode spaces', () => new Promise(done => {
      var app = express();
    ...
    it('should work with unicode', () => new Promise(done => {
      var app = express();
  ...
  it('should be .use()able', () => new Promise(done => {
    var app = express();
  ...
  describe('when given a regexp', () => {
    it('should match the pathname only', () => new Promise(done => {
      var app = express();
    ...
    it('should populate req.params with the captures', () => new Promise(done => {
      var app = express();
    ...
    it('should ensure regexp matches path prefix', () => new Promise(done => {
      var app = express()
      var p = []
  ...
  describe('case sensitivity', () => {
    it('should be disabled by default', () => new Promise(done => {
      var app = express();
    ...
    describe('when "case sensitive routing" is enabled', () => {
      it('should match identical casing', () => new Promise(done => {
        var app = express();
      ...
      it('should not match otherwise', () => new Promise(done => {
        var app = express();
  ...
  describe('params', () => {
    ...
    it('should allow merging existing req.params', () => new Promise(done => {
      ...
      router.get('/:action', (req, res) => {
        ...
        res.send(keys.map((k) => { return [k, req.params[k]] }));
      });
  ...
  describe('trailing slashes', () => {
    it('should be optional by default', () => new Promise(done => {
      var app = express();
    ...
    describe('when "strict routing" is enabled', () => {
      it('should match trailing slashes', () => new Promise(done => {
        var app = express();
      ...
      it('should pass-though middleware', () => new Promise(done => {
        var app = express();
      ...
      it('should pass-though mounted middleware', () => new Promise(done => {
        var app = express();
      ...
      it('should match no slashes', () => new Promise(done => {
        var app = express();
      ...
      it('should match middleware when omitting the trailing slash', () => new Promise(done => {
        var app = express();
      ...
      it('should match middleware', () => new Promise(done => {
        var app = express();
      ...
      it('should match middleware when adding the trailing slash', () => new Promise(done => {
        var app = express();
      ...
      it('should fail when omitting the trailing slash', () => new Promise(done => {
        var app = express();
      ...
      it('should fail when adding the trailing slash', () => new Promise(done => {
        var app = express();
  ...
  it('should allow escaped regexp', () => new Promise(done => {
    var app = express();
  ...
  it('should allow literal "."', () => new Promise(done => {
    var app = express();
  ...
  describe('*', () => {
    it('should capture everything', () => new Promise(done => {
      var app = express()
    ...
    it('should decode the capture', () => new Promise(done => {
      var app = express()
    ...
    it('should denote a greedy capture group', () => new Promise(done => {
      var app = express();
    ...
    it('should work with several', () => new Promise(done => {
      var app = express();
    ...
    it('should work cross-segment', () => new Promise(done => {
      var app = express();
      var cb = after(2, done)
    ...
    it('should allow naming', () => new Promise(done => {
      var app = express();
    ...
    it('should not be greedy immediately after param', () => new Promise(done => {
      var app = express();
    ...
    it('should eat everything after /', () => new Promise(done => {
      var app = express();
    ...
    it('should span multiple segments', () => new Promise(done => {
      var app = express();
    ...
    it('should be optional', () => new Promise(done => {
      var app = express();
    ...
    it('should require a preceding /', () => new Promise(done => {
      var app = express();
    ...
    it('should keep correct parameter indexes', () => new Promise(done => {
      var app = express();
    ...
    it('should work within arrays', () => new Promise(done => {
      var app = express();
  ...
  describe(':name', () => {
    it('should denote a capture group', () => new Promise(done => {
      var app = express();
    ...
    it('should match a single segment only', () => new Promise(done => {
      var app = express();
    ...
    it('should allow several capture groups', () => new Promise(done => {
      var app = express();
    ...
    it('should work following a partial capture group', () => new Promise(done => {
      var app = express();
      var cb = after(2, done);
    ...
    it('should work inside literal parenthesis', () => new Promise(done => {
      var app = express();
    ...
    it('should work in array of paths', () => new Promise(done => {
      var app = express();
      var cb = after(2, done);
  ...
  describe(':name?', () => {
    it('should denote an optional capture group', () => new Promise(done => {
      var app = express();
    ...
    it('should populate the capture group', () => new Promise(done => {
      var app = express();
  ...
  describe('.:name', () => {
    it('should denote a format', () => new Promise(done => {
      var app = express();
      var cb = after(2, done)
  ...
  describe('.:name?', () => {
    it('should denote an optional format', () => new Promise(done => {
      var app = express();
      var cb = after(2, done)
  ...
  describe('when next() is called', () => {
    it('should continue lookup', () => new Promise(done => {
      var app = express()
        , calls = [];
  ...
  describe('when next("route") is called', () => {
    it('should jump to next route', () => new Promise(done => {
      var app = express()
  ...
  describe('when next(err) is called', () => {
    it('should break out of app.router', () => new Promise(done => {
      var app = express()
        , calls = [];
    ...
    it('should call handler in same route, if exists', () => new Promise(done => {
      var app = express();
  ...
  it('should allow rewriting of the url', () => new Promise(done => {
    var app = express();
  ...
  it('should run in order added', () => new Promise(done => {
    var app = express();
    var path = [];
