...
describe('urlencoded()', () => {
  ...
  it('should parse x-www-form-urlencoded', () => new Promise(done => {
    request(this.app)
      .post('/')
  ...
  it('should parse extended syntax', () => new Promise(done => {
    request(this.app)
      .post('/')
      .set('Content-Type', 'application/x-www-form-urlencoded')
  ...
  describe('with extended option', () => {
    describe('when false', () => {
      ...
      it('should not parse extended syntax', () => new Promise(done => {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
          .send('user[name][first]=Tobi')
      ...
      it('should parse multiple key instances', () => new Promise(done => {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
    ...
    describe('when true', () => {
      ...
      it('should parse fully-encoded extended syntax', () => new Promise(done => {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      it('should parse array index notation', () => new Promise(done => {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      it('should parse array index notation with large array', () => new Promise(done => {
        var str = 'f[0]=0'
      ...
      it('should parse array of objects syntax', () => new Promise(done => {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      it('should parse deep object', () => new Promise(done => {
        var str = 'foo'
  ...
  describe('with parameterLimit option', () => {
    describe('with extended: false', () => {
      ...
      it('should 413 if over limit', () => new Promise(done => {
      ...
      it('should work when at the limit', () => new Promise(done => {
        request(createApp({ extended: false, parameterLimit: 10 }))
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
      ...
      it('should work if number is floating point', () => new Promise(done => {
      ...
      it('should work with large limit', () => new Promise(done => {
      ...
      it('should work with Infinity limit', () => new Promise(done => {
  ...
  describe('with type option', () => {
    ...
    describe('when ["urlencoded", "application/x-pairs"]', () => {
      ...
      it('should parse "application/x-www-form-urlencoded"', () => new Promise(done => {
        request(this.app)
          .post('/')
          .set('Content-Type', 'application/x-www-form-urlencoded')
          .send('user=tobi')
      ...
      it('should parse "application/x-pairs"', () => new Promise(done => {
        request(this.app)
          .post('/')
