...
describe('req', () => {
  describe('.subdomains', () => {
    describe('when present', () => {
      it('should return an array', () => new Promise(done => {
        var app = express();
      ...
      it('should work with IPv4 address', () => new Promise(done => {
        var app = express();
      ...
      it('should work with IPv6 address', () => new Promise(done => {
        var app = express();
    ...
    describe('when subdomain offset is set', () => {
      describe('when subdomain offset is zero', () => {
        it('should return an array with the whole domain', () => new Promise(done => {
          var app = express();
        ...
        it('should return an array with the whole IPv4', () => new Promise(done => {
          var app = express();
          app.set('subdomain offset', 0);
        ...
        it('should return an array with the whole IPv6', () => new Promise(done => {
          var app = express();
          app.set('subdomain offset', 0);
