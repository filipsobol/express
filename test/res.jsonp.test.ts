...
describe('res', () => {
  describe('.jsonp(object)', () => {
    it('should respond with jsonp', () => new Promise(done => {
      var app = express();
    ...
    it('should use first callback parameter with jsonp', () => new Promise(done => {
      var app = express();
    ...
    it('should ignore object callback parameter with jsonp', () => new Promise(done => {
      var app = express();
    ...
    it('should allow renaming callback', () => new Promise(done => {
      var app = express();
    ...
    it('should allow []', () => new Promise(done => {
      var app = express();
    ...
    it('should disallow arbitrary js', () => new Promise(done => {
      var app = express();
    ...
    it('should escape utf whitespace', () => new Promise(done => {
      var app = express();
    ...
    it('should not escape utf whitespace for json fallback', () => new Promise(done => {
      var app = express();
    ...
    it('should include security header and prologue', () => new Promise(done => {
      var app = express();
    ...
    it('should not override previous Content-Types with no callback', () => new Promise(done => {
      var app = express();
    ...
    it('should override previous Content-Types with callback', () => new Promise(done => {
      var app = express();
    ...
    describe('when given undefined', () => {
      it('should invoke callback with no arguments', () => new Promise(done => {
        var app = express()
    ...
    describe('when given null', () => {
      it('should invoke callback with null', () => new Promise(done => {
        var app = express()
    ...
    describe('when given a string', () => {
      it('should invoke callback with a string', () => new Promise(done => {
        var app = express()
    ...
    describe('when given a number', () => {
      it('should invoke callback with a number', () => new Promise(done => {
        var app = express()
    ...
    describe('when given an array', () => {
      it('should invoke callback with an array', () => new Promise(done => {
        var app = express()
    ...
    describe('when given an object', () => {
      it('should invoke callback with an object', () => new Promise(done => {
        var app = express()
