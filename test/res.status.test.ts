...
describe('res', () => {
  describe('.status(code)', () => {
    describe('when "code" is undefined', () => {
      it('should raise error for invalid status code', () => new Promise(done => {
        var app = express()
    ...
    describe('when "code" is 201', () => {
      it('should set the response status code to 201', () => new Promise(done => {
        var app = express()
    ...
    describe('when "code" is 302', () => {
      it('should set the response status code to 302', () => new Promise(done => {
        var app = express()
    ...
    describe('when "code" is 403', () => {
      it('should set the response status code to 403', () => new Promise(done => {
        var app = express()
    ...
    describe('when "code" is 501', () => {
      it('should set the response status code to 501', () => new Promise(done => {
        var app = express()
    ...
    describe('when "code" is "410"', () => {
      it('should set the response status code to 410', () => new Promise(done => {
        var app = express()
